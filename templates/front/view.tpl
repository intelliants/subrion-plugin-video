{if !empty($entry)}
    <div class="v-item-view">
        ...
        {switch $entry.source}
        {case 'youtube' break}
            <iframe src="https://www.youtube.com/embed/{$entry.url}?showinfo=0&autoplay={$core.config.video_autoplay}" width="{$core.config.video_width}" height="{$core.config.video_height}" frameborder="0" allowfullscreen></iframe>
        {case 'vimeo' break}
            <iframe src="http://player.vimeo.com/video/{$entry.url}?api=1;title=0&autoplay={$core.config.video_autoplay}" width="{$core.config.video_width}" height="{$core.config.video_height}" frameborder="0" allowfullscreen></iframe>
